            ...
            <div class="col-lg-5 col-sm-12">
                ...
                <ul>
                    ...
                    <li data-aos="fade-right" class="aos-init"><i class="fa fa-phone"></i> {{ __('Phone (Japan) :  ') }}<a href="tel:+81-36868-4986">+81-36868-4986</a></li>
                       <li data-aos="fade-right" class="aos-init"><i class="fa fa-phone"></i> {{ __('Phone (South Africa) : ') }}<a href="tel:+27-83-384-6879">+27-83-384-6879</a></li>
                    <li data-aos="fade-right" class="aos-init"><i class="fa fa-envelope"></i> {{ __('E-mail : ') }}<a href="mailto:zenventures&#64;andafrica.co.jp">zenventures&#64;andafrica.co.jp</a></li>
                </ul>
            </div>
