...
<section class="about_outer">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-sm-12 col-12"><img src="{{ url('img/creative-proccess.jpg') }}"></div>
  ...
  <section class="bg-counter-h1">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12"><img src="{{ url('img/about.jpg') }}" class="mar_t30"></div>
        </div>
    </div>
  </section>
